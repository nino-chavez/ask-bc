...
export interface components {
    schemas: {
        ...
        coupon_Base: {
             ...
             */
            min_purchase?: string;
            /** @description Specifies when a coupon expires. Coupons need not have an expiry date – you can also control expiry via + `max_uses` or `max_uses_per_customer`. If you do use this date field, the value must be in <a href="https://tools.ietf.org/html/rfc2822#section-3.3" target="_blank">RFC 2822</a> format. */
            expires?: string;
            /**
