...
export interface components {
    schemas: {
         ...
         * @enum {string}
         */
        shipping_provider_standard: "auspost" | "canadapost" | "endicia" | "usps" | "fedex" | "ups" | "upsready" | "upsonline" | "shipperhq" | "royalmail" | "";
        /**
         ...
         */
        shipping_provider_custom: string;
        /**
         * order_Resp
        ...
        orderShipment: {
             ...
             */
            shipping_method?: string;
            shipping_provider?: components["schemas"]["shipping_provider_standard"] | components["schemas"]["shipping_provider_custom"];
            /**
             * Tracking Carrier
    ...
    parameters: {
        ...
        /** @description Should be specified along with `include=consignments` or `include=consignments.line_items` to return consignments in the supported object structure. */
        consignment_structure: "object";
        /**
         * @description * `consignments&consignment_structure=object` - include the response returned from the request to the `/orders/{order_id}/consignments` endpoint.
         *     * `consignments.line_items&consignment_structure=object` - include the response returned from the request to the `/orders/{order_id}/products` endpoint in consignments. This will also includes the resources associated with `include=consignments`.
