...
export interface paths {
    ...
    "/promotions/{promotion_id}/codes": {
         ...
         * @description Deletes multiple coupon codes relating to the given promotion. Currently, batches are limited to 250 coupon codes.
         *
         *     **Notes**
...
export interface components {
    schemas: {
         ...
         * @enum {unknown}
         */
        CreatedFrom: "react_ui" | "legacy_ui" | "api";
        /**
         * PromotionBase
         ...
         */
        SavedCouponPromotion: WithRequired<components["schemas"]["PromotionBase"], "id" | "name" | "channels" | "customer" | "rules" | "notifications" | "stop" | "currency_code" | "redemption_type" | "current_uses" | "start_date" | "status" | "can_be_used_with_other_promotions"> & {
            /**
             * @description An auto-generated unique identifier for the discount rule.
             * @example 1
             */
         ...
         */
        DraftAutomaticPromotion: WithRequired<components["schemas"]["PromotionBase"], "redemption_type" | "name" | "rules"> & {
            /**
             * @description The type of the promotion. Promotions applied automatically have a value of `AUTOMATIC` whereas promotions requiring a coupon have a value of `COUPON`.
             * @enum {string}
             */
         ...
         */
        SavedAutomaticPromotion: WithRequired<components["schemas"]["PromotionBase"], "id" | "name" | "channels" | "customer" | "rules" | "notifications" | "stop" | "currency_code" | "redemption_type" | "current_uses" | "start_date" | "status" | "can_be_used_with_other_promotions"> & {
            /**
             * @description The type of the promotion. Promotions applied automatically have a value of `AUTOMATIC` whereas promotions requiring a coupon have a value of `COUPON`.
             * @enum {string}
             */
